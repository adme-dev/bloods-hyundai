...
@media (max-width: 700px) {
  .compact-metric-card { min-height: 174px; background: linear-gradient(180deg, var(--dashboard-surface, hsl(var(--card))) 58%, color-mix(in srgb, var(--dashboard-accent, #0091b8) 5%, var(--dashboard-surface, hsl(var(--card)))) 100%); }
  ...
  .compact-metric-card__footer { min-height: 42px; padding-bottom: 14px; font-size: 11.5px; }
}
</style>
