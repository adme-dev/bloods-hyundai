<template>
  <div v-if="hasSpecs" class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
    <div class="flex items-center justify-between mb-4">
      <h2 class="text-lg font-semibold text-slate-900">Detailed Specifications</h2>
      <span
        v-if="series || generation"
    ...
    <div class="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
      <span>Specifications sourced from manufacturer data</span>
      <span v-if="confidence" class="flex items-center gap-1">
        <span class="w-2 h-2 rounded-full" :class="confidenceColor"></span>
