<template>
  <div class="space-y-6">
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <NuxtLink to="/admin/settings/homepage-slider" class="group">
        <Card class="h-full transition-shadow hover:shadow-md">
          <CardContent class="flex items-center gap-4 p-6">
            <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 group-hover:bg-primary/20">
            ...
            <div>
              <h3 class="font-semibold">Homepage Slider</h3>
              <p class="text-sm text-muted-foreground">Responsive artwork, ordering & schedules</p>
            </div>
          </CardContent>
        </Card>
      </NuxtLink>
      <NuxtLink to="/admin/settings/stock-card-promo" class="group">
        <Card class="h-full transition-shadow hover:shadow-md">
          <CardContent class="flex items-center gap-4 p-6">
            <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 group-hover:bg-primary/20">
            ...
            <div>
              <h3 class="font-semibold">Stock Card Promotions</h3>
              <p class="text-sm text-muted-foreground">Was/Now pricing, badges, comments & promo graphics</p>
            </div>
          </CardContent>
        </Card>
      </NuxtLink>
...
import { Copy, Eye, EyeOff, KeyRound, Loader2, AlertCircle, RefreshCw, Palette, Mail, MailPlus, GitBranch, Wrench, Banknote, MessageSquare, PlugZap, Star, GalleryHorizontalEnd, Tags } from 'lucide-vue-next';
