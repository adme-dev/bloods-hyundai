<template>
  <div class="car-sales-page min-h-screen bg-slate-50 text-slate-900">
    ...
    <div class="px-4 py-4 lg:px-6 lg:py-5" style="background: linear-gradient(135deg, #001E50 0%, #1a4a8a 100%);">
          ...
          <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="space-y-3 border-t border-slate-100 px-4 py-4">
              <div class="relative flex items-center">
                <svg class="pointer-events-none absolute left-3 h-5 w-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
                <input
                  v-model="searchKeywords"
                  type="search"
                  class="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-4 text-sm outline-none ring-primary/20 focus:border-primary focus:ring-2"
