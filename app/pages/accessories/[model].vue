<template>
  <div class="accessories-model min-h-screen bg-slate-50 text-slate-900">
    ...
    <div class="mx-auto max-w-7xl px-4 py-8 lg:px-8">
      ...
      <!-- Error State -->
      <div v-else-if="accessoriesStore.error" class="flex flex-col items-center justify-center rounded-2xl py-16">
...
const modelData = computed(() => {
  // Models now have slugs generated from their names/titles in the store
  return HYUNDAI_MODELS.find(m => m.slug === modelSlug.value);
});
