/**
 * Generate Gravatar URL from an email address
 ...
 * @param fallback - Fallback image type: 'identicon', 'mp', 'retro', 'robohash', 'monsterid', 'wavatar', 'blank' (default: 'mp')
 * @returns Gravatar image URL
 */
export function getGravatarUrl(email: string, size = 80, fallback: string = 'mp'): string {
