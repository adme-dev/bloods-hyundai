...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "fbc9edcc-e107-4e1a-a2bd-c605adb25e3a",
  ...
  "public": {
    ...
    "siteUrl": "https://salehyundai.netlify.app",
    "apiUrl": "",
    "cdnUrl": "https://driveagent.b-cdn.net/files/sale-hyundai",
    "oemCdnUrl": "https://hyundaioem.b-cdn.net/data",
    "oemRawCdnUrl": "https://hyundaioem.b-cdn.net/raw",
  ...
  "nuxt-site-config": {
    "stack": [
      ...
      },
      {
        ...
        "_priority": -1,
        "name": "Sale Hyundai",
        "url": "https://salehyundai.netlify.app"
      }
    ],
    "version": "3.2.11",
    "debug": false,
...
const _oTytrHwa9XgFsZZtO7fzT2nZJegW_ogFcwhQPL4hhUY = defineNitroPlugin(async (nitroApp) => {
...
const _wuVOAdED6Np99E1JS7_jRBjX6WA27R1q3QTmHkiqxFY = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _oTytrHwa9XgFsZZtO7fzT2nZJegW_ogFcwhQPL4hhUY,
_wuVOAdED6Np99E1JS7_jRBjX6WA27R1q3QTmHkiqxFY
];
...
const _RjiIFm = eventHandler(async (e) => {
...
const _SJv5T3 = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _wrlCMI = defineEventHandler(async (e) => {
...
const _lazy_36WBKK = () => import('../routes/api/accessories.mjs');
const _lazy_HnxPdM = () => import('../routes/api/all-variants.mjs');
const _lazy_hLzm4d = () => import('../routes/api/car-calculator.mjs');
const _lazy_OUfiYe = () => import('../routes/api/carsales-feed.mjs');
const _lazy_XDSxQ7 = () => import('../routes/api/form.post.mjs');
const _lazy_rYCY18 = () => import('../routes/api/hyundai-offers/_id_.mjs');
const _lazy_ESOTJW = () => import('../routes/api/index.mjs');
const _lazy_jTQ2sB = () => import('../routes/api/page/_slug_.mjs');
const _lazy_cHl2hu = () => import('../routes/api/reviews.mjs');
const _lazy_usBWbT = () => import('../routes/api/search.mjs');
const _lazy_4bZPap = () => import('../routes/api/stripe/checkout-session.post.mjs');
const _lazy_fqeUka = () => import('../routes/api/stripe/create-checkout-session.post.mjs');
const _lazy_GK43Re = () => import('../routes/api/stripe/payment-intent.post.mjs');
const _lazy_n9t76Q = () => import('../routes/api/stripe/retrieve-session.post.mjs');
const _lazy_cb22GD = () => import('../routes/api/variant-details.mjs');
const _lazy_YkrU35 = () => import('../routes/api/variant-price.mjs');
const _lazy_qlXiIY = () => import('../routes/api/vehicle/_slug_.mjs');
const _lazy_cjEx7k = () => import('../routes/robots.txt.mjs');
const _lazy_33AFKN = () => import('../routes/sitemap.xml.mjs');
const _lazy_8UEJyQ = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/accessories', handler: _lazy_36WBKK, lazy: true, middleware: false, method: undefined },
  { route: '/api/all-variants', handler: _lazy_HnxPdM, lazy: true, middleware: false, method: undefined },
  { route: '/api/car-calculator', handler: _lazy_hLzm4d, lazy: true, middleware: false, method: undefined },
  { route: '/api/carsales-feed', handler: _lazy_OUfiYe, lazy: true, middleware: false, method: undefined },
  { route: '/api/form', handler: _lazy_XDSxQ7, lazy: true, middleware: false, method: "post" },
  { route: '/api/hyundai-offers/:id', handler: _lazy_rYCY18, lazy: true, middleware: false, method: undefined },
  { route: '/api/hyundai-offers', handler: _lazy_ESOTJW, lazy: true, middleware: false, method: undefined },
  { route: '/api/page/:slug', handler: _lazy_jTQ2sB, lazy: true, middleware: false, method: undefined },
  { route: '/api/reviews', handler: _lazy_cHl2hu, lazy: true, middleware: false, method: undefined },
  { route: '/api/search', handler: _lazy_usBWbT, lazy: true, middleware: false, method: undefined },
  { route: '/api/stripe/checkout-session', handler: _lazy_4bZPap, lazy: true, middleware: false, method: "post" },
  { route: '/api/stripe/create-checkout-session', handler: _lazy_fqeUka, lazy: true, middleware: false, method: "post" },
  { route: '/api/stripe/payment-intent', handler: _lazy_GK43Re, lazy: true, middleware: false, method: "post" },
  { route: '/api/stripe/retrieve-session', handler: _lazy_n9t76Q, lazy: true, middleware: false, method: "post" },
  { route: '/api/variant-details', handler: _lazy_cb22GD, lazy: true, middleware: false, method: undefined },
  { route: '/api/variant-price', handler: _lazy_YkrU35, lazy: true, middleware: false, method: undefined },
  { route: '/api/vehicle/:slug', handler: _lazy_qlXiIY, lazy: true, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _lazy_cjEx7k, lazy: true, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _lazy_33AFKN, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_8UEJyQ, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _RjiIFm, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _SJv5T3, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _wrlCMI, lazy: false, middleware: true, method: undefined },
  { route: '/**', handler: _lazy_8UEJyQ, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, createRouter$1 as A, defu as B, handler as C, getRouterParam as a, getResponseStatusText as b, createError$1 as c, defineEventHandler as d, getResponseStatus as e, defineRenderHandler as f, getQuery as g, destr as h, getRouteRules as i, joinRelativeURL as j, useNitroApp as k, hasProtocol as l, joinURL as m, withTrailingSlash as n, withoutTrailingSlash as o, parseQuery as p, isScriptProtocol as q, readBody as r, setResponseHeaders as s, getContext as t, useRuntimeConfig as u, sanitizeStatusCode as v, withQuery as w, createHooks as x, executeAsync as y, toRouteMatcher as z };
